    ...
    'docs.getText',
    {
      ...
      inputSchema: {
        ...
        tabId: z
          .string()
          .optional()
          .describe('The ID of the tab to read. If not provided, returns all tabs.'),
      },
    },
    docsService.getText
  );
    ...
    'calendar.listEvents',
    {
      ...
      inputSchema: {
        ...
        timeMin: z
          .string()
          .optional()
          .describe('The start time for the event search. Defaults to the current time.'),
    ...
    'calendar.respondToEvent',
    {
      ...
      inputSchema: {
        ...
        sendNotification: z
          .boolean()
          .optional()
          .describe('Whether to send a notification to the organizer (default: true).'),
        responseMessage: z
          .string()
          .optional()
  ...
  server.registerTool(
    'chat.sendMessage',
    {
      ...
      inputSchema: {
        spaceName: z
          .string()
          .describe('The name of the space to send the message to (e.g., spaces/AAAAN2J52O8).'),
  ...
  server.registerTool(
    'chat.getMessages',
    {
      ...
      inputSchema: {
        spaceName: z
          .string()
          .describe('The name of the space to get messages from (e.g., spaces/AAAAN2J52O8).'),
        threadName: z
          .string()
          .optional()
          .describe(
  ...
  server.registerTool(
    'chat.listThreads',
    {
      ...
      inputSchema: {
        spaceName: z
          .string()
          .describe('The name of the space to get threads from (e.g., spaces/AAAAN2J52O8).'),
  ...
  server.registerTool(
    'chat.setUpSpace',
    {
      ...
      inputSchema: {
        ...
        userNames: z
          .array(z.string())
          .describe('The user names of the members to add to the space (e.g. users/12345678)'),
      },
    },
    ...
    'gmail.search',
    {
      ...
      inputSchema: {
        ...
        maxResults: z
          .number()
          .optional()
          .describe(`Maximum number of results to return (default: ${GMAIL_SEARCH_MAX_RESULTS}).`),
...
There are a list of system labels that can be modified on a message:
    ...
    - IMPORTANT: adding IMPORTANT label marks a message as important.`,
      inputSchema: {
        messageId: z
          .string()
          .describe('The ID of the message to add labels to and/or remove labels from.'),
        addLabelIds: z
          .array(z.string())
          .max(100)
          .optional()
          .describe('A list of label IDs to add to the message. Limit to 100 labels.'),
        removeLabelIds: z
          .array(z.string())
          .max(100)
          .optional()
          .describe('A list of label IDs to remove from the message. Limit to 100 labels.'),
      },
    },
    gmailService.modify
  );
    ...
    'people.getUserProfile',
    {
      ...
      inputSchema: {
        ...
        email: z
          .string()
          .optional()
          .describe('The email address of the user to get profile information for.'),
        name: z
          .string()
          .optional()

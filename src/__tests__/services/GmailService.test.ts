...
describe('GmailService', () => {
  ...
  beforeEach(() => {
    ...
    // Setup fs mocks for this test
    const fsMock = jest.requireMock('node:fs/promises') as any;
    (fsMock.mkdir as any) = jest.fn().mockReturnValue(Promise.resolve());
    (fsMock.writeFile as any) = jest.fn().mockReturnValue(Promise.resolve());
  ...
  describe('downloadAttachment', () => {
    it('should download an attachment successfully', async () => {
      ...
      const fsMock = jest.requireMock('node:fs/promises') as any;
      (fsMock.mkdir as any) = jest.fn().mockReturnValue(Promise.resolve('/tmp'));
      (fsMock.writeFile as any) = jest.fn().mockReturnValue(Promise.resolve());
